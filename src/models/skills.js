...
export const skillCategories = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'RAG',        slug: null,            desc: 'retrieval-augmented LLMs'       },
      ...
      { name: 'Power BI',   slug: null, localImg: '/assets/icons/powerbi.svg',    desc: 'dashboards & KPIs'           },
      { name: 'Pentaho',    slug: null, localImg: '/assets/icons/pentaho.svg',   desc: 'ETL pipelines'                  },
    ],
  },
  {
    id: 'devops',
    ...
    items: [
      ...
      { name: 'AWS',        slug: null, localImg: '/assets/icons/aws.svg',         desc: 'EC2, S3, RDS, IAM'         },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'TypeORM',    slug: null, localImg: '/assets/icons/typeorm.svg',    desc: '.NET-friendly ORM'         },
